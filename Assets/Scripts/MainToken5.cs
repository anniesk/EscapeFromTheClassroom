...
public class MainToken5 : MonoBehaviour
{
    ...
    public void OnMouseDown()
    {
        ...
        if (gameControl.GetComponent<GameControl>().Loydettyget == true) {
            ...
            {
                gameControl.GetComponent<GameControl>().Tila5 = true;
                gameControl.GetComponent<GameControl>().kuinkamontakaannetty++;
                spriteRenderer.sprite = face;
            }
            else
            {
                gameControl.GetComponent<GameControl>().Tila5 = false;
                gameControl.GetComponent<GameControl>().kuinkamontakaannetty--;
